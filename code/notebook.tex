...
=======
    \title{Untitled}
>>>>>>> 54758c62596fd8945528c48ea4049d9c4dc7325b
...
{\color{incolor}In [{\color{incolor}40}]:} \PY{c+c1}{\PYZsh{} Configure Jupyter so figures appear in the notebook}
...
MMR immunization rate in 2017 = 90.7\%
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{n}{pop} \PY{o}{=} \PY{l+m+mi}{999}  \PY{c+c1}{\PYZsh{}population}
         \PY{n}{init\PYZus{}im} \PY{o}{=} \PY{l+m+mf}{0.907}    \PY{c+c1}{\PYZsh{}initial immunity of the US population}
         \PY{n}{beta} \PY{o}{=} \PY{l+m+mf}{0.9}        \PY{c+c1}{\PYZsh{}assumed contact rate}
         \PY{n}{gamma} \PY{o}{=} \PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{7}      \PY{c+c1}{\PYZsh{}US recovery rate from measles}
         \PY{n}{sigma} \PY{o}{=} \PY{l+m+mf}{0.091}\PY{p}{;}     \PY{c+c1}{\PYZsh{}US rate from exposure period of 11 days to infected}
\end{Verbatim}
...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{k}{def} \PY{n+nf}{make\PYZus{}system} \PY{p}{(}\PY{n}{pop}\PY{p}{,} \PY{n}{init\PYZus{}im}\PY{p}{,} \PY{n}{beta}\PY{p}{,} \PY{n}{gamma}\PY{p}{,} \PY{n}{sigma}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    return: System object\PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{n}{t\PYZus{}end} \PY{o}{=} \PY{l+m+mi}{365} \PY{c+c1}{\PYZsh{}number of days in 1 year}
...
simulation ends within the period.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{k}{def} \PY{n+nf}{update\PYZus{}func}\PY{p}{(}\PY{n}{state}\PY{p}{,} \PY{n}{time}\PY{p}{,} \PY{n}{system}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{n}{ds} \PY{o}{=} \PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{beta}\PY{o}{*}\PY{n}{s}\PY{o}{*}\PY{n}{i}\PY{p}{)}\PY{o}{/}\PY{n}{total\PYZus{}pop} \PY{c+c1}{\PYZsh{}change in number of people susceptible}
             \PY{n}{de} \PY{o}{=} \PY{p}{(}\PY{p}{(}\PY{n}{beta}\PY{o}{*}\PY{n}{s}\PY{o}{*}\PY{n}{i}\PY{p}{)}\PY{o}{/}\PY{n}{total\PYZus{}pop}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{sigma}\PY{o}{*}\PY{n}{e} \PY{c+c1}{\PYZsh{}change in number of people moving to exposed period}
             \PY{n}{di} \PY{o}{=} \PY{n}{sigma}\PY{o}{*}\PY{n}{e} \PY{o}{\PYZhy{}} \PY{n}{gamma}\PY{o}{*}\PY{n}{i}     \PY{c+c1}{\PYZsh{}change in people moving to infectious period}
             \PY{n}{dr} \PY{o}{=} \PY{n}{gamma}\PY{o}{*}\PY{n}{i}     \PY{c+c1}{\PYZsh{}change in people recovered}
         
             \PY{n}{s} \PY{o}{+}\PY{o}{=} \PY{n}{ds}      \PY{c+c1}{\PYZsh{}number of people susceptible}
             \PY{n}{e} \PY{o}{+}\PY{o}{=} \PY{n}{de}      \PY{c+c1}{\PYZsh{}number of people exposed}
             \PY{n}{i} \PY{o}{+}\PY{o}{=} \PY{n}{di}      \PY{c+c1}{\PYZsh{}number of people infected}
             \PY{n}{r} \PY{o}{+}\PY{o}{=} \PY{n}{dr}      \PY{c+c1}{\PYZsh{}number of people recovered}
...
day.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{k}{def} \PY{n+nf}{run\PYZus{}simulation}\PY{p}{(}\PY{n}{system}\PY{p}{,} \PY{n}{update\PYZus{}func}\PY{p}{)}\PY{p}{:}
...
state values for each time step.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{k}{def} \PY{n+nf}{plot\PYZus{}results} \PY{p}{(}\PY{n}{S}\PY{p}{,}\PY{n}{E}\PY{p}{,}\PY{n}{I}\PY{p}{,}\PY{n}{R}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{n}{init\PYZus{}im} \PY{o}{=} \PY{l+m+mf}{0.907}
...
introduced to a community of 1000 people in a real world situation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}47}]:} \PY{n}{plot\PYZus{}results}\PY{p}{(}\PY{n}{results}\PY{o}{.}\PY{n}{S}\PY{p}{,} \PY{n}{results}\PY{o}{.}\PY{n}{E}\PY{p}{,} \PY{n}{results}\PY{o}{.}\PY{n}{I}\PY{p}{,} \PY{n}{results}\PY{o}{.}\PY{n}{R}\PY{p}{)}
...
working.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{n}{init\PYZus{}im2} \PY{o}{=} \PY{l+m+mf}{0.3}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}49}]:} \PY{n}{plot\PYZus{}results}\PY{p}{(}\PY{n}{results2}\PY{o}{.}\PY{n}{S}\PY{p}{,} \PY{n}{results2}\PY{o}{.}\PY{n}{E}\PY{p}{,} \PY{n}{results2}\PY{o}{.}\PY{n}{I}\PY{p}{,} \PY{n}{results2}\PY{o}{.}\PY{n}{R}\PY{p}{)}
...
of 30\% to 90\% where the herd immunity fails to function.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}50}]:} \PY{k}{def} \PY{n+nf}{calc\PYZus{}highest\PYZus{}infected}\PY{p}{(}\PY{n}{results}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
<<<<<<< HEAD
{\color{incolor}In [{\color{incolor}51}]:} \PY{k}{def} \PY{n+nf}{sweep\PYZus{}init\PYZus{}im}\PY{p}{(}\PY{n}{imun\PYZus{}rate\PYZus{}array}\PY{p}{)}\PY{p}{:}
...
means that the disease is spreading faster.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}52}]:} \PY{n}{imun\PYZus{}rate\PYZus{}array} \PY{o}{=} \PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{21}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
<<<<<<< HEAD
{\color{outcolor}Out[{\color{outcolor}52}]:} 0.00    208.313630
         0.05    193.245208
         0.10    177.918762
         0.15    162.651083
         0.20    147.602195
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}53}]:} \PY{n}{plot}\PY{p}{(}\PY{n}{sweep}\PY{p}{)}
...
simulation must be around 80\textasciitilde{}85\% range.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}54}]:} \PY{k}{def} \PY{n+nf}{calc\PYZus{}fraction\PYZus{}infected}\PY{p}{(}\PY{n}{results}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}55}]:} \PY{k}{def} \PY{n+nf}{sweep\PYZus{}init\PYZus{}im2}\PY{p}{(}\PY{n}{imun\PYZus{}rate\PYZus{}array}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Sweep a range of values for beta.}
         \PY{l+s+sd}{    }
         \PY{l+s+sd}{    beta\PYZus{}array: array of beta values}
         \PY{l+s+sd}{    gamma: recovery rate}
...
immunity rate for a community.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}56}]:} \PY{n}{imun\PYZus{}rate\PYZus{}array} \PY{o}{=} \PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mf}{0.99}\PY{p}{,} \PY{l+m+mi}{34}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
<<<<<<< HEAD
{\color{outcolor}Out[{\color{outcolor}56}]:} 0.00    99.880178
         0.03    99.851143
         0.06    99.813900
         0.09    99.767596
         0.12    99.710066
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}57}]:} \PY{n}{plot}\PY{p}{(}\PY{n}{sweep2}\PY{p}{)}
         \PY{n}{decorate}\PY{p}{(}\PY{n}{xlabel}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Immunity Rate}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
...
immunity rate for a community of 1000 individuals is between 80-85\%.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}58}]:} \PY{n}{plot}\PY{p}{(}\PY{n}{sweep}\PY{p}{)}
         \PY{n}{decorate}\PY{p}{(}\PY{n}{xlabel}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Immunity Rate}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                 \PY{n}{ylabel} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Highest number of people infected during 1 outbreak}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                 \PY{n}{title} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Figure 3}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}59}]:} \PY{n}{plot}\PY{p}{(}\PY{n}{sweep2}\PY{p}{)}
         \PY{n}{decorate}\PY{p}{(}\PY{n}{xlabel}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Immunity Rate}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                 \PY{n}{ylabel} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+si}{\PYZpc{} o}\PY{l+s+s1}{f susceptible people getting measles during an outbreak}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                 \PY{n}{title} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Figure 4}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
